...
[bretsw.com/eme6665-fs23-module6](https://bretsw.com/eme6665-fs23-module6)

---

class: inverse, center, middle

# `r fa("comments", fill = "#fff")` <br><br> Module 5 <br> Recap
...
# `r fa("fas fa-feather-pointed", fill = "#fff")` <br><br> Module 6: <br> Elements of Style

---

# `r fa("fas fa-feather-pointed", fill = "#fff")` Module 6 Readings
...
# `r fa("fas fa-file-pen", fill = "#fff")` Peer Review Assignment
